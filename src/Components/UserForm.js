                    ...
                    <div className="modal-content">
                        ...
                        <div className="user-form">
                            <form onSubmit={onCreateUser}>
                                ...
                                <div>
                                    <input type="password" placeholder="Password" ref={pwdRef} defaultValue={props.editMode ? props.user.password : ''} />
                                ...
                                <button type='submit' className='add-user-button'>{props.editMode ? 'Update User' : 'Create User'}</button>
                            </form>
                        </div>
                    </div>
                </div>
